                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>{{ $bien_1['ten_nguoi_nhan'] }}</strong>
                                                                        đã hoàn thành thanh toán hóa đơn
                                                                        <strong>{{ $bien_1['ma_hoa_don'] }}</strong> với
                                                                        số tiền<strong>
                                                                            {{ number_format($bien_1['tong_tien']) }}đ &nbsp;</strong>thành
                                                                        công. <br>Xin cảm ơn và chúc quý khách một ngày
                                                                        tuyệt vời.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="esdev-mso-td" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;width:153px">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        width="100%" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr>
                                                    ...
                                                    <td class="esdev-mso-td" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;width:75px">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        width="100%" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr>
                                                    ...
                                                    <td class="esdev-mso-td" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;width:79px">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        width="100%" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="esdev-mso-td" valign="top"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        style="padding:0;Margin:0;width:151px">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" role="presentation"
                                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tr>
                                                                                <td align="left"
                                                                                    ...
                                                                                    <p
                                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                        <strong>{{ $value->ten_phong }} - {{ $value->ten_loai_phong }}</strong></p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <td class="esdev-mso-td" valign="top"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        style="padding:0;Margin:0;width:76px">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" role="presentation"
                                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tr>
                                                        ...
                                                        <td class="esdev-mso-td" valign="top"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <tr>
                                                                    <td align="left"
                                                                        style="padding:0;Margin:0;width:81px">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" role="presentation"
                                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tr>
                                                        ...
                                                        <td class="esdev-mso-td" valign="top"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-right"
                                                                ...
                                                                <tr>
                                                                    <td align="left"
                                                                        style="padding:0;Margin:0;width:67px">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" role="presentation"
                                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                            <tr>
                                                                                <td align="right"
                                                                                    ...
                                                                                    <p
                                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                                        {{ number_format($value->tong_gia_thue, 0, '.', ',') }}đ</p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Tổng
                                                                        Tiền:&nbsp;<strong>{{ number_format($bien_1['tong_tien'], 0, '.', ',') }}đ</strong>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Copyright DZFullStack © 2024. All right
                                                                        reserved.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
